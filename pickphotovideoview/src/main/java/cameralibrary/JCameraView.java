...
import cameralibrary.listener.CaptureListener;
...
import cameralibrary.listener.TypeListener;
import cameralibrary.state.CameraMachine;
import cameralibrary.util.FileUtil;
import cameralibrary.util.LogUtil;
import cameralibrary.util.ScreenUtils;
import cameralibrary.view.CameraView;
...
//    private static final String TAG = "JCameraView";
    ...
    private void initView() {
        ...
        //拍照 录像
        Button btnPicture = (Button) view.findViewById(R.id.camera_view_Btn_Picture);
        ...
        Button btnVideo = (Button) view.findViewById(R.id.camera_view_Btn_Video);
        btnVideo.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isVideo){
                    ...
                    machine.stopRecord(false, 10*1000);
                }
            }
        });
